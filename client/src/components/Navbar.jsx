...
function Navbar() {
  ...
  return (
    ...
    <button className='flex items-center gap-2 rounded-full text-sm cursor-pointer bg-primary text-white px-10 py-2.5'>Get Started <ArrorRight className='w-4 h-4'/></button>    
    </div>
  )
}
import { useNavigate } from 'react-router-dom'
